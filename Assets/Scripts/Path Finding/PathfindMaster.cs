...
namespace PathFinding{
    // This class controls the threads for the path finder
    public class PathfindMaster : MonoBehaviour{
        ...
        private List<Pathfinder> currentJobs;		// Running threads
        private List<Pathfinder> todoJobs;			// Queue of threads
